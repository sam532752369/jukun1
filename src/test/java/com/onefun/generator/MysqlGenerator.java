...
public class MysqlGenerator {
    //com.aaa.bbb
	private static String baoPath="com.onefun";//aaa
    ...
    private static String password ="www2320254303";
    private static String url ="jdbc:mysql://gz-cdb-jkxfrmj7.sql.tencentcdb.com:62701/test?useUnicode=true&characterEncoding=UTF-8&tinyInt1isBit=false";
    ...
    public static void main(String[] args) {
        ...
        String strPath="com."+projectName+"."+packageClass;
        if(packageClass==null||"".equals(packageClass)) {
        	strPath="com."+projectName;
        }
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                // 自定义 dao 父类
                .setSuperMapperClass(baoPath+".base.BaseDao")
                // 自定义 service 父类
                .setSuperServiceClass(baoPath+".base.BaseService")
                // 自定义 service 实现类父类
